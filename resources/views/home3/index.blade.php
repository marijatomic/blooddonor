...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets3/fonts/ionicons/css/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets3/fonts/fontawesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets3/fonts/flaticon/font/flaticon.css')}}">
...
<section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url('assets3/images/big_image_1.jpg');">
    <div class="container">
...
<section class="school-features d-flex" style="background-image: url('assets3/images/big_image_3.jpg');">
    ...
    <div class="container">
        ...
        <div class="row top-course">
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/webdesign.jpg')}}" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/wordpress.jpg')}}" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/javascript.jpg')}}" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/photoshop.jpg')}}" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/reactjs.jpg')}}" alt="Image placeholder">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                <a href="#" class="course">
                    <img src="{{asset('assets3/images/angularjs.jpg')}}" alt="Image placeholder">
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-7 order-lg-3 order-1 mb-lg-0 mb-5">
                <img src="{{asset('assets3/')}}images/person_testimonial_1.jpg" alt="Image placeholder" class="img-md-fluid">
            </div>
...
<script src="{{asset('assets3/js/jquery-migrate-3.0.0.js')}}"></script>
...
<script src="{{asset('assets3/js/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('assets3/js/jquery.stellar.min.js')}}"></script>
