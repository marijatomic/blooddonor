    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 stretch-left-1 element-animate" data-animate-effect="fadeInLeft">
                <a href="#" class="video"><img src="{{asset('assets1/img/img_1.jpg')}}" alt="" class="img-fluid"></a>
            </div>
            ...
            <div class="major-caousel js-carousel-1 owl-carousel">
                <div>
                    <div class="media d-block media-custom text-center">
                        <img src="{{asset('assets1/img/doctor_1.jpg')}}" alt="Image Placeholder" class="img-fluid">
                        <div class="media-body">
                ...
                <div>
                    <div class="media d-block media-custom text-center">
                        <img src="{{asset('assets1/img/doctor_2.jpg')}}" alt="Image Placeholder" class="img-fluid">
                        <div class="media-body">
                ...
                <div>
                    <div class="media d-block media-custom text-center">
                        <img src="{{asset('assets1/img/doctor_4.jpg')}}" alt="Image Placeholder" class="img-fluid">
                        <div class="media-body">
