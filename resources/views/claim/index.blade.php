            ...
            @foreach($claims as $claim)
                <div class="col-md-3 element-animate">
                    <div class="media d-block media-custom text-center">
                        <img src="{{asset('assets1/img/blood2.jpg')}}" alt="Image Placeholder" class="img-fluid">
                        <div class="media-body">
                            <a href="{{route('claims')}}/{{$claim->id}}"><h3 class="mt-0 text-black">{{$claim->patient_name}}</h3></a>
                            <h4 class="mt-0 text-black">{{$claim->patient_blood}}</h4>
                            <p class="mt-0 text-black">{{$claim->description}}</p>
