...
<head>
    ...
    <!-- Lightbox-->
    <link rel="stylesheet" href="{{asset('assets2/vendor/lightbox2/css/lightbox.css')}}">
    <!-- Custom font icons-->
    <link rel="stylesheet" href="{{asset('assets2/css/fontastic.css')}}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('assets2/css/style.default.css')}}" id="theme-stylesheet">
...
<header class="header">
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="./" class="navbar-brand"><img src="{{asset('assets2/img/logo.svg')}}" alt="" class="img-fluid"></a>
...
<section class="hero">
    <div class="container mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6"><img src="{{asset('assets2/img/illustration-hero.svg')}}" alt="..." class="hero-image img-fluid d-none d-lg-block"></div>
        </div>
    </div>
</section>
<!-- Intro Section-->
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 mx-auto mt-5"><img src="{{asset('assets2/img/illustration-1.svg')}}" alt="..." class="intro-image img-fluid"></div>
        </div>
    </div>
</section>
<!-- Divider Section-->
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/monitor.svg')}}" alt="..." class="img-fluid"></div>
                ...
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/target.svg')}}" alt="..." class="img-fluid"></div>
                ...
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/chat.svg')}}" alt="..." class="img-fluid"></div>
                ...
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/idea.svg')}}" alt="..." class="img-fluid"></div>
                ...
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/coffee-cup.svg')}}" alt="..." class="img-fluid"></div>
                ...
                <div class="col-lg-4">
                    <div class="box text-center">
                        <div class="icon d-flex align-items-end"><img src="{{asset('assets2/img/pen.svg')}}" alt="..." class="img-fluid"></div>
...
<section class="bg-gray">
    <div class="container">
        ...
        <div class="clients mt-5">
            <div class="row">
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-1.svg')}}" alt="" class="client-image img-fluid"></div>
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-2.svg')}}" alt="" class="client-image img-fluid"></div>
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-3.svg')}}" alt="" class="client-image img-fluid"></div>
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-4.svg')}}" alt="" class="client-image img-fluid"></div>
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-5.svg')}}" alt="" class="client-image img-fluid"></div>
                <div class="col-lg-2"><img src="{{asset('assets2/img/client-6.svg')}}" alt="" class="client-image img-fluid"></div>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-gray">
    <div class="container text-center text-lg-left">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 mt-5 mt-lg-0"><img src="{{asset('assets2/img/client-1.svg')}}img/illustration-2.svg" alt="" class="divider-image img-fluid"></div>
        </div>
    </div>
</section>
<!-- Portfolio Section-->
<section class="pb-0">
    <div class="container">
        ...
        <div class="portfolio mt-5">
            <div class="row">
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-1.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-1.jpg" alt="image" class="img-fluid"></a></div>
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-2.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-2.jpg" alt="image" class="img-fluid"></a></div>
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-3.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-3.jpg" alt="image" class="img-fluid"></a></div>
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-4.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-4.jpg" alt="image" class="img-fluid"></a></div>
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-5.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-5.jpg" alt="image" class="img-fluid"></a></div>
                <div class="col-lg-4 p-0"><a href="{{asset('assets2/img/portfolio-6.jpg')}}" data-lightbox="image-1" data-title="Some footer information" class="portfolio-item"><img src="img/portfolio-6.jpg" alt="image" class="img-fluid"></a></div>
            </div>
        </div>
    </div>
</section>
...
<script src="{{asset('assets2/vendor/popper.js/umd/popper.min.js')}}"> </script>
...
<script src="{{asset('assets2/vendor/lightbox2/js/lightbox.js')}}"></script>
